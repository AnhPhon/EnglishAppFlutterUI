...
class HomeReadingBook3 extends StatefulWidget {
  const HomeReadingBook3({Key? key}) : super(key: key);

  @override
  _HomeReadingBook3State createState() => _HomeReadingBook3State();
}

class _HomeReadingBook3State extends State<HomeReadingBook3> {
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Column(
                                      children: <Widget>[
                                        Text(
                                          "Children will also be able to practice their pronunciation with this book, which is currently sold with a CD with the book on the market. CDs are recorded by standard native speakers, helping children learn to imitate and apply basic English communication in the most natural way.",
                                          maxLines: 3,
