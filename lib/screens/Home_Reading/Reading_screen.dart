...
class HomeReadings extends StatefulWidget {
  const HomeReadings({Key? key}) : super(key: key);

  @override
  _HomeReadingsState createState() => _HomeReadingsState();
}

class _HomeReadingsState extends State<HomeReadings> {
                  ...
                  Expanded(
                    child: Column(
                      children: <Widget>[
                        ...
                        Text(
                          "Through the exercises in the book, students can accumulate effective learning methods and ways of memorizing English vocabulary and at the same time, they will learn to familiarize themselves with and consolidate their knowledge on many different topics that are close and familiar. belonging to everyday life. Each exercise on the book will be arranged from basic to advanced with eye-catching and friendly illustrations.",
                          maxLines: 7,
                          overflow: TextOverflow.ellipsis,
                        ),
                      ],
